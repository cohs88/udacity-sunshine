...
/**
 * Created by servando on 11/3/2015.
 */
...
import com.example.sunshine2.data.WeatherProvider;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void>
{
    ...
    */
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Uri locationUri = WeatherContract.LocationEntry.buildLocationUri(0);
        String selection = WeatherContract.LocationEntry.COLUMN_CITY_NAME + "=?";
        String[] selectionArgs = new String[]{cityName};
        Cursor cursor = weatherProvider.query(locationUri, null, selection, selectionArgs, null);
        Log.d("chori", Integer.toString(cursor.getCount()));
        */
